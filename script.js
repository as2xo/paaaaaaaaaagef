let sectors = [
  {color:"#A63889", label:"премиум 10 дней"},
  {color:"#490F59", label:"1000 КОИНБОКСОВ"},
  {color:"#A63889", label:"премиум на месяц"},
  {color:"#490F59", label:"ничего"},
  {color:"#A63889", label:"премиум на год"},
  {color:"#490F59", label:"ничего"},
  {color:"#A63889", label:"премиум на 3 дня"},
  {color:"#490F59", label:"ничего"},
];
